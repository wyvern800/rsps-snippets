...
public class CollectionLogOthers {
    static final int INTER = 3009;
    ...
    public static void sendInterface(Player player) {
        ...
        player.getPackets().sendIComponentText(INTER, 25, SELECTED2 + "Others</col>");
        sendItems(player, "Boss Pets", CollectionItems.CollectionType.BOSS_PETS, null, null, null, 52);
    ...
    public static void handleButtons(Player player, int componentId, int slotId2) {
        ...
        switch (componentId) {
            case 31: //examine
                ...
                break;
            case 52:
                sendItems(player, "Boss Pets", CollectionItems.CollectionType.BOSS_PETS, null, null, null, componentId);
                break;
            case 77:
                sendItems(player, "Summoning Charms", CollectionItems.CollectionType.SUMMONING_CHARMS, null, null, null, componentId);
                break;
            case 36:
                sendItems(player, "Slayer Drops", CollectionItems.CollectionType.SLAYER_DROPS, null, null, null, componentId);
                break;
            case 78: //sara
                sendItems(player, "Skill Pets", CollectionItems.CollectionType.SKILL_PETS, null, null, null, componentId);
                break;
            /*case 53: //nex
                sendItems(player, "Nex", CollectionItems.ShopType.ZAROS, null, player.getNexkills(), "Kills", 11, componentId);
                break;
            case 54:
                sendItems(player, "Tormented Demon", CollectionItems.ShopType.TORMENTED, null, player.getTormKills(), "Kills", 4, componentId);
                break;
            case 55:
                sendItems(player, "Giant Mole", CollectionItems.ShopType.GIANT_MOLE, null, player.getgiantmollykills(), "Kills", 2, componentId);
                break;
            case 56:
                sendItems(player, "Dagannoth Kings", CollectionItems.ShopType.DKS, null, player.getDksKills(), "Kills", 8, componentId);
                break;
            case 57:
                sendItems(player, "Corporeal Beast", CollectionItems.ShopType.CORPOREAL, null, player.getCorpkills(), "Kills", 8, componentId);
                break;
            case 58:
                sendItems(player, "Kalphite Queen", CollectionItems.ShopType.KQ, null, player.getKqkills(), "Kills", 3, componentId);
                break;
            case 59:
                sendItems(player, "Queen Black Dragon", CollectionItems.ShopType.QBD, null, player.getQbdkills(), "Kills", 9, componentId);
                break;
            case 60:
                sendItems(player, "King Black Dragon", CollectionItems.ShopType.KBD, null, player.getKbdkills(), "Kills", 7, componentId);
                break;
            case 61:
                sendItems(player, "Chaos Elemental", CollectionItems.ShopType.CHAOS_ELEMENTAL, null, player.getChaoselekills(), "Kills", 3, componentId);
                break;
            case 62:
                sendItems(player, "Blink", CollectionItems.ShopType.BLINK, null, player.getBlinkKills(), "Kills", 5, componentId);
                break;
            case 63:
                sendItems(player, "Sunfreet", CollectionItems.ShopType.SUNFREET, null, player.getSunfreetkills(), "Kills", 3, componentId);
                break;*/
            /*categories*/
            case 17: //Bosses
    ...
    public static void sendCattegoryNames(Player player, int componentId, String bossName) {
        ...
        player.getPackets().sendIComponentText(INTER, 52, "Boss Pets");
        player.getPackets().sendIComponentText(INTER, 77, "Summoning Charms");
        player.getPackets().sendIComponentText(INTER, 36, "Slayer Drops");
        player.getPackets().sendIComponentText(INTER, 78, "Skill Pets");
